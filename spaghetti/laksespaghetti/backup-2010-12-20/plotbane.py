...
# Takes merged file from commando line
...
try:
    ...
    print "Usage: python plotbane.py merged_file"
    sys.exit(1)
...
#plt.savefig('plotbane.png', dpi=400)
#plt.savefig('sausage.png', dpi=400)
#plt.savefig('sausage34.png', dpi=400)
#plt.savefig('plotbane_83100.png', dpi=400)
plt.show()
